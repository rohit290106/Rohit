...
ls- Force=To show all hidden files in a respiratory
...
git push origin main = upload local(laptop) repo content to remote(github) repo 

cd ..=to exit from the current folder
